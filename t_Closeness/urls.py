...
urlpatterns = [
    ...
    path('custom/<str:csv_name>/<str:caller>/<str:title_id_pair>/', json_parser_views.CustomView.as_view()),
    ...
    path('advanced_settings/<str:csv_name>/<str:caller>/<str:title_id_pair>/', json_parser_views.AdvancedSettingsView.as_view()),
]